...
(local *hotpot-ownership-marker* "-- @generated by hotpot.nvim")
(local *hotpot-ownership-marker-length* (length *hotpot-ownership-marker*))
(fn mark-ownership [source]
  (.. (string.format "%s using fennel %s, edits to this file may be lost\n"
