package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  commands.find = function(env, read, on_values, on_error, scope)
    local function _653_(_241)
      ...
      if ((_G.type(_654_) == "table") and (nil ~= (_654_).source) and ((_654_).what == "Lua") and (nil ~= (_654_).linedefined) and (nil ~= (_654_).short_src)) then
...
package.preload["fennel.friend"] = package.preload["fennel.friend"] or function(...)
  ...
  local function sub(str, start, _end)
    if utf8_ok_3f then
      return string.sub(str, utf8.offset(str, start), (utf8.offset(str, (_end + 1)) - 1))
    else
