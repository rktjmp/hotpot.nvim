...
local function new(modname, src_path, opts)
  _G.assert((nil ~= opts), "Missing argument opts on fnl/hotpot/loader/record/ftplugin.fnl:4")
  _G.assert((nil ~= src_path), "Missing argument src-path on fnl/hotpot/loader/record/ftplugin.fnl:4")
  _G.assert((nil ~= modname), "Missing argument modname on fnl/hotpot/loader/record/ftplugin.fnl:4")
  ...
  local context_dir_end_position = (#src_path0 - (1 + #"ftplugin" + 1 + #filetype + 3))
