...
M.apply = function(options)
  if (nil == options) then
    _G.error("Missing argument options on fnl/hotpot/runtime.fnl:119", 2)
  else
  end
...
M["invoke-sync-report-handler"] = function(context, report, invocation)
  if (nil == invocation) then
    _G.error("Missing argument invocation on fnl/hotpot/runtime.fnl:136", 2)
  else
  end
  if (nil == report) then
    _G.error("Missing argument report on fnl/hotpot/runtime.fnl:136", 2)
  else
  end
  if (nil == context) then
    _G.error("Missing argument context on fnl/hotpot/runtime.fnl:136", 2)
  else
  end
