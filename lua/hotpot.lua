 ...
 local function _19_() return require("hotpot.fennel") end package.preload["fennel"] = _19_ else end
 if config.enable_hotpot_diagnostics then
 local _let_21_ = require("hotpot.api.diagnostics") local enable = _let_21_["enable"]
