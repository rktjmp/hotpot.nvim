 ...
 do local _let_16_ = require("hotpot.loader") local make_searcher = _let_16_["make-searcher"] local compiled_cache_path = _let_16_["compiled-cache-path"]
 ...
 do end (package.loaders)[1] = make_searcher() end
