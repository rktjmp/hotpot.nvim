...
local hotpot_path = ensure_installed("rktjmp/hotpot.nvim", "v0.14.9")
...
ensure_installed("rktjmp/hotpot.nvim", "v0.14.9")

require("hotpot") -- Optionally you may call require("hotpot").setup(...) here

require("mini.deps").setup({path = {package = path_package}})
MiniDeps.add({source = "echasnovski/mini.nvim", checkout = "stable"})
MiniDeps.add({source = "rktjmp/hotpot.nvim", checkout = "v0.14.9"})
